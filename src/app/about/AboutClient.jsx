...
export default function AboutClient({ initialImage, isAdmin }) {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      if (!uploadRes.ok) throw new Error(upData.error || "Upload failed");
      ...
      const saveRes = await fetch("/api/settings", {
        ...
        body: JSON.stringify({ key: "about_hero_image", value: imageUrl })
      });
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              >
                <div className="aspect-[4/3] bg-neutral-200 relative overflow-hidden group">
                  {heroImage ? (
                    <Image src={heroImage} fill alt="Berztech Engineering" className="object-cover" />
                  ) : (
                  ...
                  {isAdmin && (
                    <div className="absolute inset-0 bg-neutral-900/60 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity duration-300 z-50">
                      <label className="cursor-pointer bg-white text-neutral-900 px-4 py-2 font-jetbrains-mono text-xs uppercase tracking-widest font-semibold hover:bg-neutral-100 transition-colors shadow-xl flex items-center gap-2">
