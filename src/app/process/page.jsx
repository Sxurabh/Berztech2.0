...
function PhaseCard({ phase, index, isActive, onClick }) {
    ...
    return (
        <motion.div
            ...
            className={`relative cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900 focus-visible:ring-offset-2 rounded-lg`}
        >
            <CornerFrame
                className={`
