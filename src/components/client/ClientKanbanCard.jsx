...
export default function ClientKanbanCard({ task, onClick }) {
    return (
        <div
            ...
            className="group flex flex-row items-center justify-between bg-white border rounded-sm px-3 py-2.5 gap-3 transition-all border-neutral-100 shadow-sm hover:border-neutral-300 hover:shadow-md cursor-pointer"
        >
