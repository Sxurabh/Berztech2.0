...
function CodePreview({ isHovered }) {
  const codeLines = [
    { text: "export default function App() {", indent: 0, color: "text-neutral-900" },
    { text: "return (", indent: 1, color: "text-neutral-900" },
    { text: "<View>", indent: 2, color: "text-blue-400" },
    { text: "<Component />", indent: 3, color: "text-emerald-400" },
    { text: "</View>", indent: 2, color: "text-blue-400" },
    { text: ");", indent: 1, color: "text-neutral-900" },
    { text: "}", indent: 0, color: "text-neutral-900" },
  ];
