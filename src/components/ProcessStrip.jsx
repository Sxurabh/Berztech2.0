// src/components/ProcessStrip.jsx
"use client";
...
export default function ProcessStrip() {
  ...
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 bg-white overflow-hidden">
      {/* Subtle Background - matches other components */}
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        {/* Section Header - Aligned with AITransparency/BentoGrid */}
        <motion.div
        ...
        {/* Horizontal Tab Navigation - Like AITransparency */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    {/* Number */}
                    <span className={`
                      font-space-grotesk text-2xl sm:text-3xl font-medium transition-colors
                  ...
                  {/* Duration Badge */}
                  <div className={`
                    mt-2 inline-block px-2 py-0.5 rounded text-[9px] sm:text-[10px] font-jetbrains-mono uppercase tracking-wider
                    ${activeTab === index 
        ...
        {/* Active Content Card - Compact like BentoGrid */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
