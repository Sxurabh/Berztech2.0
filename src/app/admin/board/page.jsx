                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p className="text-xs sm:text-sm font-space-grotesk text-neutral-500 mt-1">
                                {requestId ? "Manage tasks for this request" : "All tasks across requests"}
                            </p>
                        </div>
                    ...
                    {isGlobalView && (
                        <div className="relative flex items-center gap-2">
                            <FiFilter className="w-3.5 h-3.5 text-neutral-400 shrink-0" />
                            <select
                                value={selectedRequestId}
                                onChange={(e) => setSelectedRequestId(e.target.value)}
                                aria-label="Filter by request"
                                className="appearance-none bg-white border border-neutral-200 text-neutral-900 font-jetbrains-mono text-[10px] sm:text-xs uppercase tracking-wider px-3 py-2 pr-8 rounded-sm shadow-sm hover:border-neutral-300 focus:border-neutral-900 focus:ring-0 outline-none transition-colors cursor-pointer w-full sm:w-auto sm:min-w-[180px]"
                            >
